...
//            ImmutableList.of(C.TRACK_TYPE_VIDEO, C.TRACK_TYPE_AUDIO, C.TRACK_TYPE_TEXT);
    private static ImmutableList<Integer> SUPPORTED_TRACK_TYPES =
        ImmutableList.of(C.TRACK_TYPE_VIDEO, C.TRACK_TYPE_AUDIO, C.TRACK_TYPE_TEXT);
    private static final ImmutableList<Integer> VIDEO_TRACK_TYPES =
            ImmutableList.of(C.TRACK_TYPE_VIDEO);
    private static final ImmutableList<Integer> AUDIO_TRACK_TYPES =
            ImmutableList.of(C.TRACK_TYPE_AUDIO);
    private static final ImmutableList<Integer> CLOSEDCAPTION_TRACK_TYPES =
    ...
    public static boolean willHaveContent(Player player) {
        return willHaveContent(player.getCurrentTracks(), SUPPORTED_TRACK_TYPES);
    }

    /**
     * Returns whether a track selection dialog will have Closed Caption content to display if initialized with the
     * specified {@link Player}.
     */
    public static boolean willHaveCCContent(Player player) {
        return willHaveContent(player.getCurrentTracks(), CLOSEDCAPTION_TRACK_TYPES);
    }

    /**
     * Returns whether a track selection dialog will have Audio Track content to display if initialized with the
     * specified {@link Player}.
     */
    public static boolean willHaveAudioContent(Player player) {
        return willHaveContent(player.getCurrentTracks(), AUDIO_TRACK_TYPES);
    }
     ...
     */
    public static boolean willHaveContent(Tracks tracks, ImmutableList<Integer> trackTypes) {
        for (Tracks.Group trackGroup : tracks.getGroups()) {
            if (trackTypes.contains(trackGroup.getType())) {
                return true;
            }
        }
        return false;
    ...
    public static TrackSelectionDialog createForPlayer(
        ...
        SUPPORTED_TRACK_TYPES = ImmutableList.of(C.TRACK_TYPE_VIDEO);
    ...
    public static TrackSelectionDialog createCCDialogForPlayer(
            Player player, DialogInterface.OnDismissListener onDismissListener) {
        SUPPORTED_TRACK_TYPES = ImmutableList.of(C.TRACK_TYPE_TEXT);
        return createForTracksAndParameters(
                R.string.subtitle_selection_title,
                player.getCurrentTracks(),
                player.getTrackSelectionParameters(),
                /* allowAdaptiveSelections= */ true,
                /* allowMultipleOverrides= */ false,
    ...
    public static TrackSelectionDialog createAudioTrackDialogForPlayer(
            Player player, DialogInterface.OnDismissListener onDismissListener) {
        SUPPORTED_TRACK_TYPES = ImmutableList.of(C.TRACK_TYPE_AUDIO);
        return createForTracksAndParameters(
                R.string.audiotrack_selection_title,
                player.getCurrentTracks(),
                player.getTrackSelectionParameters(),
                /* allowAdaptiveSelections= */ true,
                /* allowMultipleOverrides= */ false,
